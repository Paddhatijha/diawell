...
void printBorder(int width = 80, char borderChar = '=') {
    cout << string(width, borderChar) << endl;
}

// Function to print section header
void printHeader(const string& title, int width = 80) {
    printBorder(width, '=');
    cout << centerText(title, width) << endl;
    printBorder(width, '=');
    cout << endl;
}
...
class BloodSugarTracker : public persons {
    ...
    public:
        ...
        void displayResults() const {
            ...
            printBorder(42, '-');
            cout << centerText("Average Level: " + to_string(average) + " mg/dL", 42) << endl;
            cout << centerText("Highest Level: " + to_string(highest) + " mg/dL", 42) << endl;
            cout << centerText("Lowest Level: " + to_string(lowest) + " mg/dL", 42) << endl;
        }
        ...
        void saveToFile(const string& username, const string& password) const {
            ...
            if (!fout.is_open()) {
                cout << "Error: Could not open file for saving blood sugar data." << endl;
                return;
            }
...
class InsulinDosageTracker : public persons {
    ...
    public:
        ...
        void displayInsulinResults() const {
            ...
            cout << left << setw(12) << "Date" << setw(15) << "Insulin Type" 
            ...
            printBorder(52, '-');
            cout << centerText("Total Dosage: " + to_string(totalDosage) + " units", 52) << endl;
        }
        ...
        void saveToFile(const string& username, const string& password) const {
            ...
            ofstream fout(filename, ios::trunc);
            if (!fout.is_open()) {
                cout << "Error: Could not open file for saving insulin data." << endl;
                return;
            }
...
class Questionnaire : public persons {
    ...
    public:
        ...
        int askQuestion(string question, int low, int moderate, int high) {
            int choice;
            cout << centerText(question) << endl;
            cout << centerText("1. Low risk") << endl;
            cout << centerText("2. Moderate risk") << endl;
            cout << centerText("3. High risk") << endl;
            cout << centerText("Enter choice (1/2/3): ");
            cin >> choice;
...
class MealPlanner : public persons {
    ...
    public:
        ...
        void getUserData() {
            ...
            cout << centerText("Enter date (YYYY-MM-DD): ");
            cin >> date;
            cout << centerText("Enter your blood sugar level (Low/Normal/High): ");
            cin >> sugarLevel;
        }
...
public:
    ...
    void displayRecord(string date, float sleep, float water) {
        cout << centerText("--- Record for " + date + " ---") << endl;
        cout << centerText("Sleep: " + to_string(sleep) + " hours " + (sleep < 6 ? "(Too little!)" : sleep > 9 ? "(Too much!)" : "")) << endl;
        cout << centerText("Water: " + to_string(water) + "L " + (water < 2 ? "(Drink more!)" : water > 5 ? "(Too much!)" : "")) << endl;
    }
    ...
    void addRecord() {
        ...
        cout << centerText("Enter date (YYYY-MM-DD): ");
        cin >> date;
        cout << centerText("Enter sleep hours: ");
        cin >> sleep;
        cout << centerText("Enter water intake (liters): ");
        cin >> water;
    ...
    void viewRecordByDate() {
        ...
        cout << centerText("Enter date to search (YYYY-MM-DD): ");
        cin >> searchDate;
...
bool manager::menu() {
    ...
    cout << centerText("1. Create a new account") << endl;
    cout << centerText("2. Login") << endl;
    cout << centerText("3. Exit") << endl;
    printBorder();
    cout << centerText("Enter your choice (1-3): ");
...
bool manager::create() {
    ...
    cout << centerText("WARNING: DO NOT USE SPACES IN YOUR NAME!") << endl;
    cout << centerText("Or enter Q to return to menu:") << endl;
    ...
    cout << centerText("Please Enter Your Password:") << endl;
    cout << centerText("WARNING: DO NOT USE SPACES IN YOUR PASSWORD!") << endl;
    cout << centerText("Or enter Q to return to menu:") << endl;
    ...
    cout << centerText("WARNING: ONLY NUMERICAL VALUES ALLOWED!") << endl;
    
    int inches;
    cout << centerText("Please Enter Your Height In Inches (NOTE: 60 Inches is 5 Feet):") << endl;
    cin >> inches;
    while(!inches) {
        cout << centerText("Invalid Input, Please Enter Your Height In Inches:") << endl;
        cin.clear();
        cin.ignore();
        cin >> inches;
    }
    ...
    int weight;
    cout << centerText("Please Enter Your Weight In Pounds:") << endl;
    cin >> weight;
    while(!weight) {
        cout << centerText("Invalid Input, Please Enter Your Weight In Pounds:") << endl;
        cin.clear();
        cin.ignore();
        cin >> weight;
    }
    ...
    int age;
    cout << centerText("Please Enter Your Age:") << endl;
    cin >> age;
    while(!age) {
        cout << centerText("Invalid Input, Please Enter Your Age:") << endl;
        cin.clear();
        cin.ignore();
        cin >> age;
    }
...
bool manager::login() {
    ...
    printHeader("LOGIN");
    cout << centerText("Please Enter Your User Name:") << endl;
    cout << centerText("WARNING: DO NOT USE SPACES IN YOUR NAME!") << endl;
    cout << centerText("Or enter Q to return to menu:") << endl;
...
bool manager::options(persons* person) {
    ...
    while(1) {
        ...
        cout << centerText("1. Personalized Blood Sugar Report") << endl;
        cout << centerText("2. Personalized Insulin Dosage Report") << endl;
        cout << centerText("3. Personalized Meal Plan") << endl;
        cout << centerText("4. Diabetic Risk Assessment Test") << endl;
        cout << centerText("5. Water and Sleep Tracker") << endl;
        cout << centerText("6. Exit Program") << endl;
        printBorder();
        cout << centerText("Enter your choice (1-6): ");
        cin >> o;
        ...
        if (o == "1") {
            ...
            do {
                ...
                cout << centerText("1. Add a new blood sugar entry") << endl;
                cout << centerText("2. View all entries and statistics") << endl;
                cout << centerText("3. Return to Main Menu") << endl;
                printBorder();
                cout << centerText("Enter your choice (1-3): ");
                cin >> choice;
                ...
                switch (choice) {
                    case 1: {
                        ...
                        cout << centerText("Enter date (YYYY-MM-DD): ");
                        cin >> date;
                        cout << centerText("Enter time of day (Morning/Afternoon/Evening/Fasting): ");
                        cin >> timeOfDay;
                        cout << centerText("Enter blood sugar level (mg/dL): ");
                        cin >> sugarLevel;
            ...
            do {
                ...
                cout << centerText("1. Add Insulin Dosage Entry") << endl;
                cout << centerText("2. View Dosage Report") << endl;
                cout << centerText("3. Get Dosage Recommendation") << endl;
                cout << centerText("4. Return to Main Menu") << endl;
                printBorder();
                cout << centerText("Enter your choice (1-4): ");
                cin >> choice;
                ...
                switch (choice) {
                    case 1:
                        ...
                        cout << centerText("Enter date (YYYY-MM-DD): ");
                        cin >> date;
                        cout << centerText("Enter Insulin Type (e.g., Rapid, Long-acting): ");
                        cin >> insulinType;
                        cout << centerText("Enter Time of Day (e.g., Morning, Afternoon, Night): ");
                        cin >> timeOfDay;
                        cout << centerText("Enter Dosage (in units): ");
                        cin >> dosage;
                    ...
                    case 3: {
                        ...
                        cout << centerText("Enter Current Blood Sugar Level (mg/dL): ");
                        cin >> bloodSugarLevel;
            ...
            do {
                ...
                cout << centerText("1. Add New Record") << endl;
                cout << centerText("2. View All Records") << endl;
                cout << centerText("3. View Record by Date") << endl;
                cout << centerText("4. Return to Main Menu") << endl;
                printBorder();
                cout << centerText("Enter your choice (1-4): ");
                cin >> choice;

...
class manager: public persons{
    ...
    class BloodSugarTracker : public persons {
        ...
        public:
            ...
            void addEntry(const string& timeOfDay, double bloodSugarLevel) {
                if (entryCount < MAX_ENTRIES) {
                    entries[entryCount++] = {timeOfDay, bloodSugarLevel};
                } else {
            ...
            void saveToFile(const string& username, const string& password) const {
                ...
                // Save blood sugar entries
                for (int i = 0; i < entryCount; i++) {
                    fout << entries[i].timeOfDay << " " << entries[i].bloodSugarLevel << endl;
                }
            ...
            void loadFromFile(const string& username, const string& password) {
                ...
                // Read blood sugar entries
                entryCount = 0;
                string timeOfDay;
                double bloodSugarLevel;
        
                while (fin >> timeOfDay >> bloodSugarLevel && entryCount < MAX_ENTRIES) {
                    entries[entryCount++] = {timeOfDay, bloodSugarLevel};
                }
        ...
        class InsulinDosageTracker : public persons {
            ...
            public:
                ...
                void saveToFile(const string& username, const string& password) const {
                    ...
                    for (int i = 0; i < insulinEntryCount; i++) {
                        fout << insulinEntries[i].insulinType << " " 
                ...
                void loadFromFile(const string& username, const string& password) {
                    ...
                    insulinEntryCount = 0;
                    string insulinType, timeOfDay;
                    double dosage;
            
                    while (fin >> insulinType >> dosage >> timeOfDay && insulinEntryCount < MAX_INSULIN_ENTRIES) {
                        insulinEntries[insulinEntryCount++] = {insulinType, dosage, timeOfDay};
                    }
...
bool manager::create(){
  ...
  persons* person;
  person = new persons(name, password);
...
bool manager::options(persons* person) {
    ...
    while(1){
        ...
        cout << "Enter 2 For Your Personalized Insulin Dosage Report:" << endl << endl;
        ...
        if (o == "1") {
            ...
            // Pass the name and password to the tracker
            string name = person->getName();
            string password = person->getPassword();
            ...
            do {
                ...
                switch (choice) {
                    case 1:
                        ...
                        tracker.saveToFile(name, password); // Save data to file
                        break;
                    case 2:
                        tracker.loadFromFile(name, password); // Reload data from file
                        tracker.displayResults(); // Display the report
                        break;
                    case 3:
                        tracker.saveToFile(name, password); // Save data before exiting
        ...
        do {
            ...
            switch (choice) {
                ...
                case 2:
                    tracker.loadFromFile(name, password); // Reload data from file
                    tracker.displayInsulinResults(); // Display the report
                    break;
                case 3:
                    tracker.saveToFile(name, password); // Save data before exiting
                    cout << "Exiting the tracker. Goodbye!" << endl;
        ...
        else if (o=="4")
        {
            string name = person->getName();
            string password = person->getPassword();
            persons user(name, password); // Example username and password

    cout << "\nAre you likely diabetic or at risk? Find out through this test.\n";
    ...
    return 0;
        ...
        else if (o=="3")
        {
            ...
            persons user(name, password);
                ...
                // Create MealPlanner object with the persons object
